...
NegOSu is the customer-facing business operating system and repository folder name; the npm package is `negosu`. ServiceCore remains an internal architecture name. The two currently supported commercial verticals are **NegOSu Automotive** and **NegOSu Salon & Beauty**.
