  ...
  return (
    <main id="negosu-accept-invitation-page" className="grid min-h-dvh place-items-center bg-slate-50 p-5">
      <Card id="negosu-accept-invitation-card" elevation="md" className="w-full max-w-md p-6">
        <p className="text-sm font-medium text-brand-primary-strong">Staff invitation</p>
        <h1 className="mt-2 text-3xl font-medium">Join this business on {productBrand.name}</h1>
        ...
        <form id="negosu-accept-invitation-form" action={acceptInvitation} className="mt-6">
          ...
          <SubmitButton id="negosu-accept-invitation-button" pendingText="Accepting…"><CheckIcon aria-hidden="true" size={16} className="shrink-0"/>Accept invitation</SubmitButton>
        </form>
      </Card>
    </main>
  );
