  ...
  return (
    <main id="negosu-not-found-page" className="grid min-h-dvh place-items-center bg-slate-50 px-5">
      <section id="negosu-not-found-content" className="max-w-lg text-center">
        ...
        <h1 className="mt-3 text-4xl font-medium tracking-tight text-brand-ink">We couldn&apos;t find that page.</h1>
        <p className="mt-4 text-zinc-600">The link may be outdated, or the page may not be available yet.</p>
        <Button id="negosu-not-found-dashboard-button" asChild className="mt-7"><Link href="/dashboard"><ArrowLeftIcon aria-hidden="true" size={16} className="shrink-0"/>Back to dashboard</Link></Button>
      </section>
    </main>
  );
}
