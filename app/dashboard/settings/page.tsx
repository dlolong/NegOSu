      ...
      <div className="mt-5 grid min-w-0 grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <Card id="settings-appearance-section" elevation="none" className="min-w-0 p-5 sm:p-6 lg:col-span-2">
          <div className="flex items-start gap-3">
            ...
            <div><h2 className="text-lg font-semibold text-admin-text">Workspace color theme</h2><p id="settings-theme-help" className="mt-1 text-sm text-admin-text-secondary">Choose a color palette for your workspace.</p></div>
          </div>
