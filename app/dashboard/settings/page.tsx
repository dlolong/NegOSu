import { Save as SaveIcon, Search as SearchIcon, Settings as SettingsIcon, Check, Palette } from "lucide-react";
      ...
      <div className="mt-5 grid gap-4 lg:grid-cols-2">
        ...
        <Card id="settings-appearance-section" elevation="none" className="p-5 sm:p-6 lg:col-span-2">
          ...
          <form id="settings-theme-form" action={updateDashboardTheme} className="mt-5">
            ...
            <div className="mt-4 flex flex-wrap items-center justify-between gap-3"><p className="text-xs text-admin-text-muted">This changes dashboard colors only. Your public business page keeps its customer-facing branding.</p><FormActions id="settings-theme-actions"><SubmitButton id="settings-theme-save-button" pendingText="Applying theme…"><SearchIcon aria-hidden="true" size={16} className="shrink-0"/>Apply color theme</SubmitButton></FormActions></div>
          </form>
        </Card>
      </div>
    </main>
