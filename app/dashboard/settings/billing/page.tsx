      ...
      {hasLoadError ? <Card id="billing-load-error" className="mt-5 p-6 text-center" role="alert"><h2 className="font-semibold text-admin-text">Could not load billing</h2><p className="mx-auto mt-2 max-w-xl text-sm text-admin-text-secondary">Try loading this page again. Your subscription was not changed. If this continues, contact support.</p><Button id="billing-retry-button" asChild variant="secondary" className="mt-4"><a href="/dashboard/settings/billing"><RefreshCwIcon aria-hidden="true" size={16} className="shrink-0"/>Try again</a></Button></Card> : <>
        <Card id="billing-current-plan" elevation="none" className="mt-5 overflow-hidden">
          <div className="grid gap-5 p-5 sm:p-6 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-center">
            ...
            {subscription?.provider_customer_id ? <form id="billing-portal-form" action={openBillingPortal}><SubmitButton id="billing-manage-subscription-button" pendingText="Opening…" variant="secondary"><CreditCardIcon aria-hidden="true" size={16} className="shrink-0"/>Manage subscription</SubmitButton></form> : null}
          </div>
