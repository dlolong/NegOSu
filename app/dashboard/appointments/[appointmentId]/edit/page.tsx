...
export default async function Page({ params, searchParams }: { params: Promise<{ appointmentId: string }>; searchParams: Promise<{ customerQ?: string; error?: string }> }) {
  ...
  return <div className="mx-auto max-w-3xl"><p className="text-sm font-bold text-brand-primary">Appointments</p><h1 className="mt-1 text-3xl font-semibold">Edit appointment</h1><div className="mt-6">{form}</div></div>;
}
