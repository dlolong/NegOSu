      ...
      <div className="flex flex-wrap justify-between gap-4">
        ...
        {canManage && (
          <Button
            ...
            asChild
          >
            <Link href={`/dashboard/services/${service.id}/edit`}><PencilIcon aria-hidden="true" size={16} className="shrink-0"/>
              Edit {serviceLabel}
            </Link>
          </Button>
        )}
        ...
        >
          ...
          {canManage && (
            <form action={toggleService} className="mt-5">
              ...
              ><PowerIcon aria-hidden="true" size={16} className="shrink-0"/>
                {service.is_active
