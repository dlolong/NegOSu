  ...
  return <main id="customer-communication-preferences-page" className="mx-auto max-w-xl">
    ...
    <Card id="customer-communication-preferences-card" className="mt-6 p-5">
      <form id="customer-communication-preferences-form" action={saveCommunicationPreferences} className="space-y-4">
        ...
        <FormActions id="customer-communication-preferences-actions" cancelHref={`/dashboard/customers/${customerId}`}><SubmitButton id="customer-communication-preferences-save-button" pendingText="Saving…"><SaveIcon aria-hidden="true" size={16} className="shrink-0"/>Save preferences</SubmitButton></FormActions>
      </form>
    </Card>
  </main>;
}
