...
export default async function MyWorkPage({ searchParams }: { searchParams: Promise<Query> }) {
  ...
  return <main id="technician-my-work-page" className="mx-auto min-w-0 max-w-7xl">
    ...
    {!jobsError && !actorError ? <DashboardChart id="technician-work-chart" title="Assigned work by status" description="Visible assignments from the latest 100 active branch jobs." points={statusChart(assignedJobs)}/> : null}
