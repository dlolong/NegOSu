...
export const metadata: Metadata = {
  ...
  description: "Compare NegOSu plans for Automotive, Salon & Beauty, Pet Care, and Apartelle & Inn.",
  ...
  return (
    <main id="negosu-plans-page" className="min-h-screen overflow-x-clip bg-white text-brand-ink">
      ...
      <header id="negosu-plans-header" className="mx-auto max-w-7xl px-4 pb-3 pt-10 sm:px-6 sm:pt-14">
        <p className="text-sm font-medium text-brand-primary-strong">NegOSu pricing</p>
        <h1 className="mt-2 max-w-3xl text-4xl font-medium tracking-tight sm:text-5xl">A practical plan for every stage of your service business.</h1>
        <p className="mt-4 max-w-2xl text-base leading-7 text-zinc-600 sm:text-lg">Use the same secure operating platform with workflows tailored to Automotive, Salon &amp; Beauty, Pet Care, and Apartelle &amp; Inn.</p>
      </header>
      <PublicPlanCatalog />
