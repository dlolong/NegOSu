...
select throws_ok($$insert into invoice_items(invoice_id,organization_id,description_snapshot,quantity,unit_price_centavos,line_total_centavos) values((select id from invoices where organization_id='25000000-0000-4000-8000-000000000001'),'25000000-0000-4000-8000-000000000002','attack',1,1,1)$$,'P0001','Invoice item tenant mismatch','cross-tenant invoice item rejected');
