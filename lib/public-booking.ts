...
export type PublicShop={industry:"automotive"|"salon"|"pet_care";slug:string;name:string;description:string|null;logoUrl:string|null;coverUrl:string|null;phone:string|null;email:string|null;website:string|null;facebook:string|null;instagram:string|null;branches:PublicBranch[];services:PublicService[];gallery:{url:string;alt:string}[]};
