...
export const environmentVariableCatalog = {
  ...
  QA_SEED_APPROVED_TARGET_URL: { classification: "TEST_ONLY", purpose: "Binds fixture writes to the approved disposable database identity.", secret: false },
