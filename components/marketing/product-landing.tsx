        ...
        <details id="negosu-mobile-menu" className="group relative sm:hidden">
          ...
          <nav id="negosu-mobile-navigation" className="absolute right-0 z-30 mt-2 w-[min(18rem,calc(100vw-2rem))] rounded-2xl border border-zinc-200 bg-white p-2 shadow-lg" aria-label="Mobile navigation">
            ...
            <div className="mt-2 grid gap-2 border-t border-zinc-100 pt-2">
              ...
              <Link id="negosu-mobile-start-free-button" href={signupPath} className="inline-flex min-h-11 items-center justify-center rounded-xl bg-brand-primary px-4 text-sm font-bold text-white"><PlayIcon aria-hidden="true" size={16} className="shrink-0"/>Start Free</Link>
            </div>
          </nav>
        </details>
      </div>
    ...
    <section id={`negosu-${vertical}-hero`} className="mx-auto grid w-full max-w-7xl gap-8 px-4 pb-12 pt-9 sm:px-6 sm:pb-16 sm:pt-12 lg:min-h-[calc(100svh-4rem)] lg:grid-cols-[1.04fr_.96fr] lg:items-center lg:gap-12 lg:py-14">
      <div>
        ...
        <div className="mt-7 flex flex-col gap-3 min-[380px]:flex-row">
          ...
          <a id={`negosu-${vertical}-explore-features-button`} href={`#negosu-${vertical}-features`} className="inline-flex min-h-11 items-center justify-center rounded-xl border border-brand-border bg-white px-5 py-3 font-bold text-brand-ink hover:bg-brand-tint"><ArrowRightIcon aria-hidden="true" size={16} className="shrink-0"/>Explore Features</a>
        </div>
      </div>
