...
export function PasswordFields({ current = false, idPrefix = "auth" }: { current?: boolean; idPrefix?: string }) {
  ...
  return (
    <>
      <label className="block text-sm font-medium" htmlFor={`${idPrefix}-password-input`}>
      ...
      <label className="block text-sm font-medium" htmlFor={`${idPrefix}-confirm-password-input`}>
        Confirm password
