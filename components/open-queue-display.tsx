...
export function OpenQueueDisplay({ branchId, id = "queue-display-open", label = "Open queue display" }: { branchId: string; id?: string; label?: string }) {
  const href = `/display/queue/${encodeURIComponent(branchId)}`;
